	...
	void homeScreen()
{
	...
	outtextxy(50, 260, "Guided By Ms. Zeba");	// Faculty

	settextstyle(8 , 0 , 4);

	outtextxy(50, 350, "210422	---Abdullah Bagdadi");	// Participants Roll No
...
//	outtextxy(542, 130, " computer *");
	...
	void piano(int stx, int sty, int enx, int eny)
	{
		...
		outtextxy(stx - 17, sty + 200, "a");
		outtextxy((stx + 30) - 17, sty + 200, "b");
		outtextxy((stx + 60) - 17, sty + 200, "c");
		outtextxy((stx + 90) - 17, sty + 200, "d");
		outtextxy((stx + 120) - 17, sty + 200, "e");
		outtextxy((stx + 150) - 17, sty + 200, "f");
		outtextxy((stx + 180) - 17, sty + 200, "g");
		outtextxy((stx + 210) - 17, sty + 200, "h");
		outtextxy((stx + 240) - 17, sty + 200, "i");
		outtextxy((stx + 270) - 17, sty + 200, "j");
		outtextxy((stx + 300) - 17, sty + 200, "k");
		outtextxy((stx + 330) - 17, sty + 200, "l");
		outtextxy((stx + 360) - 17, sty + 200, "m");
		outtextxy((stx + 390) - 17, sty + 200, "n");
		outtextxy((stx + 420) - 17, sty + 200, "o");
		outtextxy((stx + 450) - 17, sty + 200, "p");
		outtextxy((stx + 480) - 17, sty + 200, "q");
		outtextxy((stx + 510) - 17, sty + 200, "r");
	}
};
