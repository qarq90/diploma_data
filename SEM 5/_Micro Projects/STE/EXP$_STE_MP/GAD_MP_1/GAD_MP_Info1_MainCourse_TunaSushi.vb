...
Public Class GAD_MP_Info1_MainCourse_TunaSushi
    ...
    Private Sub GAD_MP_MainCourse_TunaSushi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Enabled = True
        Me.Text = "Food Hub | Main Course | Tuna Sushi"
        Timer1.Interval = 500
        Label1.Text = "Tuna Sushi"
        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Text = "Japanese Tuna " & vbCrLf & "sushi is known for its " & vbCrLf & "rich and savory flavor," & vbCrLf & " and is often enjoyed" & vbCrLf & " with soy sauce, wasabi, " & vbCrLf & "and pickled ginger for " & vbCrLf & "added taste and freshness."
