...
Public Class GAD_MP_Info2_Drinks_RedWine
    ...
    Private Sub GAD_MP_ITEMADD_DRINKS_REDVINE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Food Hub | Drinks | Red Wine"
        Label3.Text = " Our red wine is carefully" & vbCrLf & " crafted from the finest grapes," & vbCrLf & " harvested at the peak of " & vbCrLf & "ripeness, and expertly fermented " & vbCrLf & "and aged to perfection, " & vbCrLf & "resulting in a wine that " & vbCrLf & "is a symphony of flavors, " & vbCrLf & "aromas, and textures."
