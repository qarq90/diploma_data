...
Public Class GAD_MP_Info3_Desserts_Sundae
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        GAD_MP_Info5_ItemAdded_Desserts.cheese.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Macrons.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.IceSundea.Visible = True
        GAD_MP_Info5_ItemAdded_Desserts.Pie.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.softie.Visible = False
    ...
    Private Sub GAD_MP_Info3_Desserts_Sundae_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Icecream Sundea"

        Label3.Text = "Picture a lavish bowl" & vbCrLf & " filled to the brim " & vbCrLf & "with velvety, creamy ice " & vbCrLf & "cream, carefully " & vbCrLf & "scooped and piled high. "
