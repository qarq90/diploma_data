...
Public Class GAD_MP_Info4_DealB
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Me.Close()
        GAD_MP_Info5_DealAdded.un1.Visible = False
    End Sub
    ...
    Sub q1()
        ...
        Dim senderN1 As String = "Tuna Shushi"
        Dim senderP1 As String = "$39.99"
        ...
        GAD_MP_Form7_Cart.ListBox3.Items.Add(senderQ1)
    ...
    Sub q2()
        ...
        Dim senderN2 As String = "Lime Mojito"
        Dim senderP2 As String = "$5.99"
        ...
        GAD_MP_Form7_Cart.ListBox3.Items.Add(senderQ2)
    ...
    Sub q3()
        ...
        Dim senderN3 As String = "Icecream Sfotie"
        Dim senderP3 As String = "$11.49"
        ...
        GAD_MP_Form7_Cart.ListBox3.Items.Add(senderQ3)
