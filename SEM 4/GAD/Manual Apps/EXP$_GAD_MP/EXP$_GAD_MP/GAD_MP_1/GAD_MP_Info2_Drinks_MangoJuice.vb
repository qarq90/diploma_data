...
Public Class GAD_MP_Info2_Drinks_MangoJuice
    ...
    Private Sub GAD_MP_ITEMADD_DRINKS_MANGOJUICE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Food Hub | Drinks | Mango Juice"
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Label3.Text = "A juice made up" & vbCrLf & " fresh Alphanso Mangoes" & vbCrLf & " which will refresh " & vbCrLf & "your body."
