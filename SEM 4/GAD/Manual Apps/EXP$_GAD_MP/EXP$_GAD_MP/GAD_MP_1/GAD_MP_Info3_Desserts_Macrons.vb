...
Public Class GAD_MP_Info3_Desserts_Macrons
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        GAD_MP_Info5_ItemAdded_Desserts.CupCake.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.cheese.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Macrons.Visible = True
        GAD_MP_Info5_ItemAdded_Desserts.IceSundea.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Pie.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.softie.Visible = False
    ...
    Private Sub GAD_MP_Info3_Desserts_Macrons_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Macrons"

        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Font = New Font("Microsoft JhengHei", 9.0)

        Label3.Text = "These delicate and " & vbCrLf & "colorful confections are " & vbCrLf & "a true work of art, " & vbCrLf & "handcrafted with care " & vbCrLf & "and precision by our s" & vbCrLf & "killed pastry chefs. "
