...
Public Class GAD_MP_Info2_Drinks_CoolBerg
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Drinks | CoolBerg"

        Label3.Text = "A drinks to celebrate " & vbCrLf & "a special occasion, or " & vbCrLf & "simply a delicious and" & vbCrLf & " healthy drink to quench" & vbCrLf & " your thirst, Coolberg " & vbCrLf & "is the ultimate" & vbCrLf & " destination for taste " & vbCrLf & "and refreshment."
