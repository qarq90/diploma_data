...
Public Class GAD_MP_Info1_MainCourse_BeefSteak
    ...
    Private Sub GAD_MP_MainCourse_BeefSteak_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Text = "Foob Hub | Main Course | Beef Steak"
        Timer1.Enabled = True
        Timer1.Interval = 500
        Label1.Text = "Beef Steak"
        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Text = "Enjoy an almost effortless " & vbCrLf & " alfresco meal of marinated " & vbCrLf & " skirt steak cooked on " & vbCrLf & " a grill, plus " & vbCrLf & " blue-cheese-topped " & vbCrLf & " potatoes and corn-flecked " & vbCrLf & " spinach salad."
