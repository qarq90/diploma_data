...
Public Class GAD_MP_Info2_Drinks_OrangeJuice
    ...
    Private Sub GAD_MP_ITEMSADDED_ORANGEJUICEE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Food Hub | Drinks | Orange Juice"
        Label3.Text = "With its bright and cheerful " & vbCrLf & "color, our orange juice is a " & vbCrLf & "visual delight that promises " & vbCrLf & "to awaken your senses from " & vbCrLf & "the very first sip."
