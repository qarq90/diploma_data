...
Public Class GAD_MP_Info3_Desserts_FruitCake
    ...
    Private Sub GAD_MP_Info3_Desserts_FruitCake_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Fruit Cake"

        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Font = New Font("Microsoft JhengHei", 9.0)

        Label3.Text = "Each bite is a burst of " & vbCrLf & "natural sweetness, showcasing " & vbCrLf & "the natural flavors and" & vbCrLf & " colors of Mother Nature's " & vbCrLf & "bounty."
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        GAD_MP_Info5_ItemAdded_Desserts.PanCake.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.fruit.Visible = True
        GAD_MP_Info5_ItemAdded_Desserts.CupCake.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.cheese.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Macrons.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.IceSundea.Visible = False
