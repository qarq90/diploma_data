...
Public Class GAD_MP_Info2_Drinks_Mojito
    ...
    Private Sub GAD_MP_ITEMADD_DRINKS_MOJITO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Food Hub | Drinks | Lime Mojito"
        Label3.Text = "Take a sip and be " & vbCrLf & "instantly refreshed by" & vbCrLf & " the zesty notes of lime," & vbCrLf & " the aromatic aroma of " & vbCrLf & "fresh mint, and the" & vbCrLf & " smooth warmth of rum. "
