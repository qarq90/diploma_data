...
Public Class GAD_MP_Info3_Desserts_CherryPie
    ...
    Private Sub GAD_MP_Info3_Desserts_CherryPie_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Cherry Pie"

        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Font = New Font("Microsoft JhengHei", 9.0)

        Label3.Text = "Made with love and care," & vbCrLf & " our cherry pie is a " & vbCrLf & "symphony of juicy" & vbCrLf & " cherries, nestled in a" & vbCrLf & " flaky, buttery crust, and " & vbCrLf & "baked to golden perfection."
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        GAD_MP_Info5_ItemAdded_Desserts.Pie.Visible = True
