...
Public Class GAD_MP_Info2_DRINKS_WATER
    ...
    Private Sub GAD_MP_DRINKS_WATER_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Food Hub | Drinks | Mineral Water"
        Label3.Text = "Refresh yourselves " & vbCrLf & " by having mineral water."
