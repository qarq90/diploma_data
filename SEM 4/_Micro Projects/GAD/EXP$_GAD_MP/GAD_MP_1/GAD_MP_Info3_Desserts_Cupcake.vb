...
Public Class GAD_MP_Info3_Desserts_Cupcake
    ...
    Private Sub GAD_MP_Info3_Desserts_Cupcake_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 500
        Timer1.Enabled = True
        Me.Text = "Food Hub | Desserts | Cup Cake"

        Label1.Font = New Font("Microsoft JhengHei", 14.0)

        Label3.Font = New Font("Microsoft JhengHei", 9.0)

        Label3.Text = "Our moist caramel cupcake" & vbCrLf & " is filled with gooey caramel " & vbCrLf & "sauce, then topped with a" & vbCrLf & " generous swirl of salted" & vbCrLf & " caramel buttercream" & vbCrLf & " frosting. "
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        GAD_MP_Info5_ItemAdded_Desserts.PanCake.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.fruit.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.CupCake.Visible = True
        GAD_MP_Info5_ItemAdded_Desserts.cheese.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Macrons.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.IceSundea.Visible = False
        GAD_MP_Info5_ItemAdded_Desserts.Pie.Visible = False
